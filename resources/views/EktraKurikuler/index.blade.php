        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12 mt-lg-12 text-center">
            <div data-aos="fade-up" data-aos-delay="100">
              <h1 class="mb-2" data-aos="fade-up">Ekstra KuriKuler Sekolah</h1>
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="500">
                ...
                <figure>
                    ...
                    <img src="{{url('front/images/sma6.jpg') }}" alt="Image" class="img-fluid">
                </figure>
                <div class="p-3">
                    <h3 style="color:#009B4C;">Kaiara Spencer</h3>
                    <span class="position">Product Manager</span>
            ...
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="500">
                ...
                <figure>
                    ...
                    <img src="{{url('front/images/sma4.jpg') }}" alt="Image" class="img-fluid">
                </figure>
                <div class="p-3">
                    <h3 style="color:#009B4C;">Kaiara Spencer</h3>
                    <span class="position">Product Manager</span>
